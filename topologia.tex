...
\tadIgualdadObservacional{top}{top'}{topo}
               {computadoras(top) = computadoras(top') \\ $ \land$ 
							  conexiones(top) = conexiones(top')}
...
\tadAlinearAxiomas{quitarConexion, $conexion$)}
